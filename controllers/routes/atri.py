...
class Atri:
	def __init__(self, state: Any):
		...
		self.Header_Flex1 = state["Header_Flex1"]
		self.Flex2 = state["Flex2"]
		self.Flex3 = state["Flex3"]
		self.Header_TextBox1 = state["Header_TextBox1"]
	...
	@property
	def Header_Flex1(self):
		self._getter_access_tracker["Header_Flex1"] = {}
		return self._Header_Flex1
	@Header_Flex1.setter
	def Header_Flex1(self, new_state):
		self._setter_access_tracker["Header_Flex1"] = {}
		global default_state
		self._Header_Flex1 = Flex(new_state, default_state["Header_Flex1"])
	...
	@property
	def Header_TextBox1(self):
		self._getter_access_tracker["Header_TextBox1"] = {}
		return self._Header_TextBox1
	@Header_TextBox1.setter
	def Header_TextBox1(self, new_state):
		self._setter_access_tracker["Header_TextBox1"] = {}
		global default_state
		self._Header_TextBox1 = TextBox(new_state, default_state["Header_TextBox1"])
	...
	def _to_json_fields(self):
		return {
			"Header_Flex1": self._Header_Flex1,
			"Flex2": self._Flex2,
			"Flex3": self._Flex3,
			"Header_TextBox1": self._Header_TextBox1,
			"Link1": self._Link1,
			"Link2": self._Link2,
			"Link3": self._Link3,
